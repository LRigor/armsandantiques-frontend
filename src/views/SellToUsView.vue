<template>
  ...
  <div class="pb-12 md:pb-16 lg:pb-24 relative bg-[#161616]">
    ...
    >
      ...
      >
        <p>Let us know what you have available.</p>
        <p>Selling to us is fast and easy.</p>
      </div>
      ...
      <div class="flex flex-col gap-6 px-4 mx-auto text-[#ccc] text-lg">
        <p class="pb-6">
          We are always seeking to acquire new items and are willing to pay a fair price negotiated
          with you. We particularly seek out Indo-Persian, Mughal Indian, Chinese, Tibetan,
          Caucasian, American, European, Asian, Sri Lankan, Korean, and South Seas or Polynesian
          artifacts.
        </p>
        <p>
          1.Please send us pictures by email to info@armsandantiques.com or upload your pictures
          into our convenient form.
        </p>
        <p>
          2.Let us know how much you would like to receive for your item. Whatever the price we
          agree on, rest assured that we will work with you to come to an equitable solution.
        </p>
        <p>
          3.If we accept your offer, or you accept our counter-offer, then we ask that you ship the
          we ask that you ship the item to us for a three day inspection period, beginning from the
          time of delivery. Almost always we are already certain of the purchase and will not return
          the item. We are professionals and our integrity is based on our word and expertise.
          However, in the unlikely event that we receive something that is different from that shown
          in the images provided or as described we reserve the right to return the item at our
          expense.
        </p>
      </div>
    </div>
